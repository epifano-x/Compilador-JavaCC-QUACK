...
/** Backup a number of characters. */
  ...
  {
    if (inputStream != null)
      throw new Error("\n   ERRO: Segunda chamada ao construtor de um SimpleCharStream estático.\n" +
      "       Você deve usar ReInit() ou definir a opção JavaCC STATIC como false\n" +
      "       durante a geração desta classe.");
    inputStream = dstream;
    line = startline;
