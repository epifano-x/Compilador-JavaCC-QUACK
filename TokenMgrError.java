...
public class TokenMgrError extends Error {
  ...
  protected static String LexicalErr(boolean EOFSeen, int lexState, int errorLine, int errorColumn, String errorAfter,
      int curChar) {
    return ("Erro lexical na linha " + //
        errorLine + ", coluna " + //
        errorColumn + ".  Encountrado: " + //
        (EOFSeen ? "<EOF>" : ("'" + addEscapes(String.valueOf(curChar)) + "' (" + curChar + "),")) + //
        (errorAfter == null || errorAfter.length() == 0 ? "" : " depois do prefixo \"" + addEscapes(errorAfter) + "\""))
        + //
        (lexState == 0 ? "" : " (em estado lexical " + lexState + ")");
  }
...
/*
 * JavaCC - OriginalChecksum=a4febed657c4dc3b56056b602e429de4 (do not edit this
 * line)
 */
